...
const CreateBlog = () => {
    ...
    const [showThumbnailUpdateText, setShowThumbnailUpdateText] =
        useState(true);
    ...
    const handleRemoveThumbnail = () => {
        setShowThumbnailUpdateText(false);
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="createBlog">
                    <div className="grid place-items-center cursor-pointer bg-slate-600/20 h-[150px] rounded-md my-4 relative">
                        {location.state &&
                            ...
                            showThumbnailUpdateText && (
                                <p className="text-md text-yellow-500">
                                    Please upload your thumbnail again to update
                                    it
                                </p>
                            )}
                        {thumbnailPreview ? (
